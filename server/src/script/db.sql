...
describe professor;
insert into professor(cod_professor, nome, sobrenome) values('AAA002', 'Rodeny', 'Victor');
insert into professor(cod_professor, nome, sobrenome) values('AAA003', 'Alan', 'Carlos');
insert into professor(cod_professor, nome, sobrenome) values('AAA004', 'Eduardo', 'Afonso');
insert into professor(cod_professor, nome, sobrenome) values('AAA005', 'Marcio', 'Silva');
