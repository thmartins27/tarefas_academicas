...
GRANT INSERT ON db_tarefas_academicas TO 'saTarefas'@'localhost';
GRANT UPDATE ON db_tarefas_academicas TO 'saTarefas'@'localhost';
GRANT DELETE ON db_tarefas_academicas TO 'saTarefas'@'localhost';